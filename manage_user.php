...
if (isset($_GET['delete'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM  needer WHERE id=$userid ");
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-primary"> <i class="fa fa-eye" aria-hidden="true"></i> </a>
                                     <a href="manage_user.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
